    ...
    <a href="{{ route('portfolio.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'portfolio.index') ? ' active' : '' }}">{{ __('Portfolio') }} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

    <a href="{{ route('footer_index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::segment(2) == 'footer') ? ' active' : '' }}">{{ __('Footer') }} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
