...
Route::group(
    ...
    Route::get('portfolio/create/', 'PortfolioController@portfolio_create')->name('portfolio_create');
    Route::post('portfolio/store/', 'PortfolioController@portfolio_store')->name('portfolio_store');
    Route::get('portfolio/edit/{key}', 'PortfolioController@portfolio_edit')->name('portfolio_edit');
    Route::post('portfolio/update/{key}', 'PortfolioController@portfolio_update')->name('portfolio_update');
    Route::get('portfolio/delete/{key}', 'PortfolioController@portfolio_delete')->name('portfolio_delete');

    Route::get('footer', 'FooterController@index')->name('footer_index');
