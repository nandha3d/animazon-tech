...
class LandingPageSetting extends Model
{
    ...
    public static function settings()
    {
        ...
        $settings = [
            ...
            "footer_status" => "on",
            "footer_address" => "155, Above Bake Mart, Nasiyanur Road, Narayana Valasu, Erode, Tamilnadu, India - 638011",
            "footer_email" => "info@animazon.in",

            "portfolio_status" => "on",
            "portfolio_title" => "PORTFOLIO",
            "portfolio_heading" => "Our Work Speaks For Itself",
            "portfolio_description" => "Explore our diverse range of projects across 3D animation, web development, and mobile applications.",
            "portfolios" => "",
