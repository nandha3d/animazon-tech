                    ...
                    @if (Gate::check('manage budget plan') || Gate::check('income vs expense report') ||
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                <li
                                    class="dash-item dash-hasmenu {{ Request::segment(1) == 'cost-calculator' ? 'active dash-trigger' : '' }}">
                                    <a class="dash-link" href="#">{{ __('Pricing') }}<span
                                            class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                    <ul class="dash-submenu">
                                        <li
                                            class="dash-item {{ Request::segment(1) == 'cost-calculator' ? 'active' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('cost-calculator.public') }}">{{ __('Cost Calculator') }}</a>
                                        </li>
                                    </ul>
                                </li>
