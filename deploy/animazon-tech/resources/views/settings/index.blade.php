...
@push('script-page')
    <script>
        ...
        $('.colorPicker').on('click', function(e) {
            ...
            // Sync with primary_color input if it exists
            if($('input[name="primary_color"]').length > 0) {
                $('input[name="primary_color"]').val(input.value);
            }
        });
        ...
        $(document).on('change', 'input[name="primary_color"]', function() {
            var color = $(this).val();
            $(':root').css('--color-customColor', color);
                                    ...
                                    <div class="row row-gap-1">
                                        ...
                                        <div class="col-xl-4 col-sm-6 col-12">
                                            <div class="card h-100 mb-0">
                                                <div class="card-header p-3">
                                                    <h6 class="mb-0 d-flex align-items-center gap-2">
                                                        <i class="ti ti-color-swatch"></i>{{ __('Brand Colors') }}
                                                    </h6>
                                                </div>
                                                <div class="card-body p-3">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-0">
                                                                {{ Form::label('primary_color', __('Primary Color'), ['class' => 'form-label']) }}
                                                                {{ Form::color('primary_color', Utility::getValByName('primary_color'), ['class' => 'form-control form-control-color w-100', 'title' => __('Choose Primary Color')]) }}
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-0">
                                                                {{ Form::label('secondary_color', __('Secondary Color'), ['class' => 'form-label']) }}
                                                                {{ Form::color('secondary_color', Utility::getValByName('secondary_color'), ['class' => 'form-control form-control-color w-100', 'title' => __('Choose Secondary Color')]) }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
