                ...
                <li class="dropdown dash-h-item drp-company">
                    <a class="dash-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="theme-avtar">
                             <img src="<?php echo e(!empty(\Auth::user()->avatar) ? \App\Models\Utility::get_file('uploads/avatar/'.\Auth::user()->avatar) :  \App\Models\Utility::get_file('uploads/avatar/avatar.png')); ?>" class="img-fluid rounded border-2 border border-primary">
                        </span>
                        ...
                        <div class="dropdown-menu dash-h-dropdown dropdown-menu-end" style="width: 320px; max-height: 400px; overflow-y: auto;">
                            ...
                            <div class="noti-body">
                                <?php $__empty_1 = true; $__currentLoopData = $unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    ?>
                                    <a href="<?php echo e($url); ?>" class="dropdown-item py-3 border-bottom">
                                        <div class="d-flex align-items-center">
                                            <div class="theme-avtar bg-primary text-white">
                                                <i class="ti ti-receipt"></i>
                                            </div>
                                            <div class="ms-3 text-wrap" style="width: 210px;">
                                                <h6 class="m-0 mb-1 font-weight-bold text-dark"><?php echo e($data['visitor_name'] ?? 'New Estimate'); ?></h6>
                                                <p class="m-0 text-sm text-muted lh-sm"><?php echo e($data['project_type'] ?? 'Project Inquiry'); ?> - <?php echo e(\App\Models\Utility::priceFormat($data['grand_total'] ?? 0)); ?></p>
                                                <small class="text-muted mt-1 d-block"><?php echo e($notification->created_at->diffForHumans()); ?></small>
                                            </div>
                                        </div>
                                    </a>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <div class="dropdown-item text-center py-4">
                                        <p class="m-0 text-sm text-muted"><?php echo e(__('No new notifications')); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php /**PATH D:\PROJECTS\WEBSITES\animazon-tech\resources\views/partials/admin/header.blade.php ENDPATH**/ ?>