...
<?php if(isset($setting['cust_theme_bg']) && $setting['cust_theme_bg'] == 'on'): ?>
    <nav class="dash-sidebar <?php echo e((isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on') ? '' : 'light-sidebar'); ?> transprent-bg">
<?php else: ?>
    <nav class="dash-sidebar <?php echo e((isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on') ? '' : 'light-sidebar'); ?>">
<?php endif; ?>
    ...
    <div class="m-header main-logo">
        <a href="#" class="b-brand">
            ...
            <?php if(isset($setting['cust_darklayout']) && $setting['cust_darklayout'] == 'on'): ?>
                <img src="<?php echo e(\App\Models\Utility::get_file('uploads/logo/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-light.png')) . '?' . time()); ?>"
                    alt="<?php echo e(config('app.name', 'ANIMAZON')); ?>" class="logo logo-lg">
            <?php else: ?>
                <img src="<?php echo e(\App\Models\Utility::get_file('uploads/logo/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png')) . '?' . time()); ?>"
                    alt="<?php echo e(config('app.name', 'ANIMAZON')); ?>" class="logo logo-lg">
            <?php endif; ?>
        ...
        <?php if(\Auth::user()->type != 'client'): ?>
            <ul class="dash-navbar">
                ...
                <?php if(\Auth::user()->type == 'company'): ?>
                    <li class="dash-item <?php echo e(Request::segment(1) == 'analytics' ? ' active' : ''); ?>">
                        <a href="<?php echo e(route('analytics.index')); ?>" class="dash-link">
                    ...
                    <?php if(Gate::check('manage budget plan') || Gate::check('income vs expense report') ||
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                <li
                                    class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'cost-calculator' ? 'active dash-trigger' : ''); ?>">
                                    <a class="dash-link" href="#"><?php echo e(__('Pricing')); ?><span
                                            class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                    <ul class="dash-submenu">
                                        <li
                                            class="dash-item <?php echo e(Request::segment(1) == 'cost-calculator' ? 'active' : ''); ?>">
                                            <a class="dash-link"
                                                href="<?php echo e(route('cost-calculator.public')); ?>"><?php echo e(__('Cost Calculator')); ?></a>
                                        </li>
                                    </ul>
                                </li>
...
<?php /**PATH D:\PROJECTS\WEBSITES\animazon-tech\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>