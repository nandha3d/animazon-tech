                            ...
                            <div class="row row-gap-1">
                                <div class="col-md-4 col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <?php echo e(Form::text('title_text', Utility::getValByName('title_text') ? Utility::getValByName('title_text') : 'ANIMAZON', ['class' => 'form-control', 'placeholder' => __('Title Text')])); ?>
                        ...
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    ?>
                                    <?php echo e(Form::select('site_currency', $currencyList, isset($setting['site_currency']) ? $setting['site_currency'] : 'USD', ['class' => 'form-control selectric font-style currency_preview', 'required', 'id' => 'site_currency'])); ?>

                                    <small> <?php echo e(__('Note: Select currency code as per three-letter ISO code.')); ?><br>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECTS\WEBSITES\animazon-tech\resources\views/settings/company.blade.php ENDPATH**/ ?>