...
<section class="py-12 bg-animazon-black text-animazon-white min-h-screen">
    <div class="container mx-auto px-4 lg:px-8">
        ...
        <div class="flex flex-wrap items-center gap-2 text-sm mb-8">
            <a href="<?php echo e(url('/pricing')); ?>" class="text-animazon-muted hover:text-primary transition-colors flex items-center gap-1">
                <i class="ti ti-arrow-left"></i> All Services
            </a>
            <span class="text-animazon-border">/</span>
            <span class="text-animazon-muted"><?php echo e($projectType->parent->name ?? ''); ?></span>
            <span class="text-animazon-border">/</span>
            <span class="text-primary font-semibold"><?php echo e($projectType->name); ?></span>
        </div>
        ...
        <div class="flex flex-wrap gap-2 mb-8 pb-4 border-b border-animazon-border/30">
            <?php $__currentLoopData = $siblings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sib): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(url('/pricing/' . $sib->slug . '?country=' . request('country', 'US'))); ?>"
                   class="px-4 py-2 rounded-lg text-sm font-medium transition-all
                          <?php echo e($sib->id == $projectType->id
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h1 class="text-2xl md:text-3xl font-bold text-animazon-white"><?php echo e($projectType->name); ?></h1>
                        <p class="text-animazon-muted text-sm"><?php echo e($projectType->description); ?></p>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    <div class="flex justify-between items-center text-xs text-animazon-muted mb-2">
                        <span id="stepLabel">Step 1 of <?php echo e(count($questions)); ?></span>
                        <span id="progressPct" class="font-mono text-primary"><?php echo e(count($questions) > 0 ? round(100 / (count($questions) + 1)) : 0); ?>%</span>
                    </div>
                    <div class="w-full h-2 bg-animazon-navy rounded-full overflow-hidden shadow-inner shadow-black/50">
                        <div id="progressBar" class="h-full rounded-full bg-gradient-to-r from-primary to-secondary transition-all duration-500 shadow-[0_0_10px_theme('colors.primary')]"
                             style="width: <?php echo e(count($questions) > 0 ? round(100 / (count($questions) + 1)) : 0); ?>%"></div>
                    </div>
                </div>
                ...
                <div id="questionsContainer">
                    <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="question-step bg-animazon-navy border border-animazon-border/30 rounded-2xl p-6 md:p-8 <?php echo e($index > 0 ? 'hidden' : ''); ?>"
                             data-step="<?php echo e($index); ?>"
                             data-question-id="<?php echo e($question->id); ?>"
                             data-question-type="<?php echo e($question->type); ?>">

                            <div class="mb-6">
                                <?php if($question->category): ?>
                                    <span class="inline-block px-3 py-0.5 rounded-full bg-primary/20 text-primary text-xs font-bold uppercase mb-3"><?php echo e($question->category); ?></span>
                                <?php endif; ?>
                                <h2 class="text-xl md:text-2xl font-bold text-animazon-white">
                                    <?php echo e($question->question); ?>

                                    <?php if($question->required): ?><span class="text-secondary">*</span><?php endif; ?>
                                </h2>
                                <?php if($question->description): ?>
                                    <p class="text-animazon-muted text-sm mt-2"><?php echo e($question->description); ?></p>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="space-y-3">
                                <?php $__currentLoopData = $question->answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="answer-option group block cursor-pointer border border-animazon-border/30 rounded-xl p-4 hover:border-primary/50 transition-all duration-200"
                                           ...
                                           data-multiplier="<?php echo e($answer->cost_multiplier); ?>"
                                           data-additional="<?php echo e($answer->additional_cost); ?>"
                                           data-answer-text="<?php echo e($answer->answer_text); ?>"
                                           data-is-enterprise="<?php echo e($answer->is_enterprise ? 'true' : 'false'); ?>">
                                        <div class="flex items-start gap-3">
                                            <?php if($question->type === 'multi_select'): ?>
                                                <input type="checkbox"
                                                       name="q_<?php echo e($question->id); ?>[]"
                                            ...
                                            <div class="flex-1 <?php echo ($question->type === 'input') ? 'mt-2' : ''; ?>">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <?php if(!$answer->is_included && !$answer->is_enterprise): ?>
                                                        <span class="flex items-center gap-2">
                                                            <?php if($answer->cost_multiplier != 1.0): ?>
                                                                <span class="text-xs text-primary/80 font-mono multiplier-tag"
                                                                      data-multiplier="<?php echo e($answer->cost_multiplier); ?>">×<?php echo e($answer->cost_multiplier); ?></span>
                                                            <?php endif; ?>

                                                            <?php if($answer->additional_cost > 0): ?>
                                                                <span class="text-xs text-secondary font-mono additional-cost-tag"
                                                                      data-usd="<?php echo e($answer->additional_cost); ?>">
                                                                    +$<?php echo e(number_format($answer->additional_cost, 0)); ?>
                                                ...
                                                <?php if($answer->explanation): ?>
                                                    <p class="text-animazon-muted text-xs mt-1"><?php echo e($answer->explanation); ?></p>
                                                <?php endif; ?>
                                                
                                                <?php if($answer->insight): ?>
                                                    <div class="mt-2 bg-blue-50 border border-blue-200 rounded-lg px-3 py-2 text-xs text-blue-900 font-medium leading-relaxed insight-box hidden">
                                                        <i class="ti ti-bulb mr-1 text-amber-500 text-sm"></i> <?php echo e($answer->insight); ?>

                                                    </div>
                                                <?php endif; ?>
                                                
                                                
                                                <?php if(str_contains(strtolower($answer->answer_text), 'woocommerce') || str_contains(strtolower($answer->answer_text), 'wordpress')): ?>
                                                ...
                                                <?php elseif(str_contains(strtolower($answer->answer_text), 'shopify')): ?>
                                                    <div class="mt-4 grid grid-cols-1 xl:grid-cols-2 gap-4 insight-box hidden">
                                                        <div class="bg-green-500/10 border border-green-500/20 rounded-xl p-4">
                                                            <h4 class="text-green-400 text-sm font-bold uppercase mb-3 flex items-center gap-1"><i class="ti ti-check"></i> Pros</h4>
                                                            <ul class="text-sm text-animazon-white/80 space-y-2">
                                                ...
                                                <?php elseif(str_contains(strtolower($answer->answer_text), 'custom stack')): ?>
                                                ...
                                                <?php elseif(str_contains(strtolower($answer->answer_text), 'cash on delivery')): ?>
                                                ...
                                                <?php elseif(str_contains(strtolower($answer->answer_text), 'shipping courier integration')): ?>
                                                ...
                                                <?php elseif(str_contains(strtolower($answer->answer_text), 'razorpay integration')): ?>
                                                ...
                                                <?php elseif(str_contains(strtolower($answer->answer_text), 'stripe integration')): ?>
                                                ...
                                                <?php elseif(str_contains(strtolower($answer->answer_text), 'paypal integration')): ?>
                                                ...
                                                <?php elseif(str_contains(strtolower($answer->answer_text), 'shared hosting setup')): ?>
                                                    <div class="mt-4 bg-animazon-black/30 border border-animazon-border/50 rounded-xl p-4 insight-box hidden">
                                                ...
                                                <?php elseif(str_contains(strtolower($answer->answer_text), 'cloud & amc standard') || str_contains(strtolower($answer->answer_text), 'vps hosting setup')): ?>
                                                    <div class="mt-4 bg-animazon-black/30 border border-animazon-border/50 rounded-xl p-4 insight-box hidden">
                                                ...
                                                <?php elseif(str_contains(strtolower($answer->answer_text), 'enterprise amc')): ?>
                                                    <div class="mt-4 bg-animazon-black/30 border border-animazon-border/50 rounded-xl p-4 insight-box hidden">
                    ...
                    <div class="question-step hidden bg-animazon-navy border border-animazon-border/30 rounded-2xl p-6 md:p-8"
                         data-step="<?php echo e(count($questions)); ?>" id="submitStep">
                        <?php if($projectType->base_cost == 0): ?>
                            ...
                            <div class="mt-4 p-4 bg-animazon-black/50 border border-animazon-border/20 rounded-xl">
                                <label class="flex items-start gap-3 cursor-pointer group">
                                    ...
                                    <span class="text-sm text-animazon-muted group-hover:text-animazon-white transition-colors">
                                        I agree to the 
                                        <a href="<?php echo e(route('terms')); ?>" target="_blank" class="text-primary hover:underline font-semibold">Terms & Conditions</a>
                    ...
                    <div id="successMessage" class="hidden bg-animazon-navy border border-primary/30 rounded-2xl p-8 md:p-12 text-center">
                        ...
                        <a href="<?php echo e(url('/pricing')); ?>" class="btn-primary-custom">
                ...
                <div id="navButtons" class="flex justify-between mt-6">
                    ...
                    <div class="ml-auto flex gap-3">
                        <a href="<?php echo e(url('/pricing')); ?>" id="backToServices"
                ...
                <div class="sticky top-24 bg-animazon-navy border border-animazon-border/30 rounded-2xl p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <select id="sidebarCountrySelect"
                            ...
                            <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($code); ?>" <?php echo e($code === request('country', 'US') ? 'selected' : ''); ?>>
                                    <?php echo e($currencies[$code]['symbol']); ?> <?php echo e($currencies[$code]['code']); ?> — <?php echo e($name); ?>
                    ...
                    <div class="flex items-center gap-3 bg-animazon-black/50 rounded-xl p-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-bold text-animazon-white"><?php echo e($projectType->name); ?></p>
                        </div>
                    </div>
                        ...
                        <?php else: ?>
                            <div class="flex justify-between">
                                ...
                                <span class="text-animazon-white font-semibold" id="sidebarBaseCost"
                                      data-usd="<?php echo e($projectType->base_cost); ?>">
                                    $<?php echo e(number_format($projectType->base_cost, 0)); ?>
...
<script>
    // ─── State ───────────────────────────────────────────────────
    const projectTypeId = <?php echo e($projectType->id); ?>;
    const baseCostUsd = <?php echo e($projectType->base_cost); ?>;
    const totalSteps = <?php echo e(count($questions)); ?>;
    const currencyMap = <?php echo json_encode($currencies, 15, 512) ?>;

    let currentStep = 0;
    let selectedAnswers = {};
    let hasEnterprise = false;
    let currentCountry = '<?php echo e(request("country", "US")); ?>';
    ...
    const isCustom = <?php echo e($projectType->base_cost == 0 ? 'true' : 'false'); ?>;
    ...
    function recalculate() {
        ...
        fetch('<?php echo e(url("/pricing/calculate")); ?>', {
            method: 'POST',
            headers: {
    ...
    function submitEstimate() {
        ...
        const isCustomProject = <?php echo e($projectType->base_cost == 0 ? 'true' : 'false'); ?>;
        ...
        fetch('<?php echo e(url("/pricing/submit")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECTS\WEBSITES\animazon-tech\resources\views/cost-calculator/public-calculator.blade.php ENDPATH**/ ?>