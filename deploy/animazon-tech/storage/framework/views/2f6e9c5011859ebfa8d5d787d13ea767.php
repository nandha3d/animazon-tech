...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end d-flex">
        <a href="<?php echo e(route('accountstatement.export')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Export')); ?>"
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::open(['route' => ['report.account.statement'], 'method' => 'get', 'id' => 'report_account'])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::month('start_month', isset($_GET['start_month']) ? $_GET['start_month'] : date('Y-m', strtotime('-5 month')), ['class' => 'month-btn form-control'])); ?>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::select('type', $types, isset($filter['type']) ? strtolower($filter['type']) : '', ['class' => 'form-control select', 'placeholder' => __('Select Category')])); ?>
    ...
    <div id="printableArea">
        <div class="row mt-3">
            <div class="col mb-4">
                <input type="hidden"
                    value="<?php echo e(__('Account Statement') . ' ' . $filter['type'] . ' ' . 'Report of' . ' ' . $filter['startDateRange'] . ' to ' . $filter['endDateRange']); ?>"
                    id="filename">
                <div class="card report-card h-100 mb-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0"><?php echo e(__('Account Statement Summary')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col mb-4">
                    <div class="card report-card h-100 mb-0">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div class="report-info flex-1">
                                <h5 class="mb-1"><?php echo e(__('Account')); ?> :</h5>
                                <p class="text-muted mb-0"><?php echo e($filter['account']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-4">
                    <div class="card report-card h-100 mb-0">
                        <div class="card-body d-flex align-items-center gap-3">
                            ...
                            <div class="report-info flex-1">
                                <h5 class="mb-1"><?php echo e(__('Type')); ?> :</h5>
                                <p class="text-muted mb-0"><?php echo e($filter['type']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card report-card h-100 mb-0">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div class="report-info flex-1">
                            ...
                            <p class="text-muted mb-0"><?php echo e($filter['endDateRange'] . ' to ' . $filter['startDateRange']); ?>
                            ...
                            <div class="card-body d-flex align-items-center gap-3">
                                ...
                                <div class="report-info flex-1">
                                    <?php if($account->holder_name == 'Cash'): ?>
                                        <h5 class="mb-1"><?php echo e($account->holder_name); ?></h5>
                                    <?php elseif(empty($account->holder_name)): ?>
                                        <h5 class="mb-1"><?php echo e(__('Stripe / Paypal')); ?></h5>
                                    <?php else: ?>
                                        <h5 class="mb-1"><?php echo e($account->holder_name . ' - ' . $account->bank_name); ?></h5>
                                    <?php endif; ?>
                                    <p class="text-muted mb-0"><?php echo e(\Auth::user()->priceFormat($account->total)); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECTS\WEBSITES\animazon-tech\resources\views/report/statement_report.blade.php ENDPATH**/ ?>