    ...
    <div class="modal-body">
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" id="email" name="email" placeholder="<?php echo e(__('Enter email')); ?>" required/>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\PROJECTS\WEBSITES\animazon-tech\resources\views/settings/test_mail.blade.php ENDPATH**/ ?>