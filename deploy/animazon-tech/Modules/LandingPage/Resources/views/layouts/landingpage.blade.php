...
<head>
    <title>{{ $setting['title_text'] ? $setting['title_text'] : config('app.name', 'ANIMAZON') }}</title>
    <!-- Meta -->
    <meta charset="utf-8" />
            ...
            <nav class="navbar navbar-expand-md  default top-nav-collapse">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav">
                        ...
                        @endif
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('cost-calculator.index') }}">{{ __('Cost Calculator') }}</a>
                        </li>
...
@if ($settings['home_status'] == 'on')
    ...
    <section class="main-banner bg-primary" id="home">
        <canvas id="heroGameCanvas"></canvas>
        <div class="container-offset hero-overlay-content">
...
<footer class="site-footer bg-gray-100">
    ...
    <div class="border-top border-dark text-center p-2">
        <p class="mb-0"> &copy;
            {{ date('Y') }}
            {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'ANIMAZON') }}
        </p>
